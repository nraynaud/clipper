...
namespace ClipperMultiPathsLib
{
  ...
  public class MultiPaths
  {
    ...
    public static void ClipCallback(IntPoint bot1, IntPoint top1, IntPoint bot2, IntPoint top2, ref IntPoint intersectPt) 
    {
      ...
      if (Math.Abs(bot1.Z - bot2.Z) == 2) 
      {
        //adjacent vertices in same segment
        intersectPt.Z = bot1.Z;
        intersectPt.Z = (Int64)((UInt64)bot1.Z & 0xFFFFFFFF00000000 | 
          ((UInt32)bot1.Z + (UInt32)bot2.Z)) / 2;
      }
      else if (Math.Abs((bot1.Z & 0xFFFF) - (bot2.Z & 0xFFFF)) == 2 &&
        Math.Abs(((bot1.Z >> 16) & 0xFFFF7FFFFFFF) - ((bot2.Z >> 16) & 0xFFFF7FFFFFFF)) < 2)
      {
        //adjacent vertices, one being an overlap vertex from the same or adjacent segment
        intersectPt.Z = (((UInt64)bot1.Z & 0xFFFF7FFFFFFF0000) != 0 ? bot2.Z : bot1.Z) +
                        ((bot1.Z & 0xFFFF) + (bot2.Z & 0xFFFF)) / 2;
      }
      else
      {
        //we've hit the end of a segment (nb: stripping of any overlap flag too)
        if ((UInt32)bot1.Z == 0)
          intersectPt.Z = (Int64)((UInt64)bot2.Z & 0xFFFF7FFFFFFFFFFF) + 1;
        else if ((UInt32)bot2.Z == 0)
          intersectPt.Z = (Int64)((UInt64)bot1.Z & 0xFFFF7FFFFFFFFFFF) + 1;
        else if (bot1.Z > bot2.Z)
          intersectPt.Z = (Int64)((UInt64)bot2.Z & 0xFFFF7FFFFFFFFFFF) + 1;
        else
          intersectPt.Z = (Int64)((UInt64)bot1.Z & 0xFFFF7FFFFFFFFFFF) + 1;
      }
